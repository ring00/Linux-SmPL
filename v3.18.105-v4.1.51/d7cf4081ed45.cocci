...
+ unsigned int fn(const struct nf_hook_ops * ops, struct sk_buff * skb, const struct nf_hook_state * state, unsigned int (*)(const struct nf_hook_ops *, struct sk_buff *, const struct nf_hook_state *, struct nf_conn *) do_chain)
 {
     <...
- nf_nat_ipv4_fn(ops, skb, in, out, do_chain)
+ nf_nat_ipv4_fn(ops, skb, state, do_chain)
     ...>
 }
...
@@
 ...
 {
     <...
- nf_nat_ipv4_in(ops, skb, state->in, state->out, F0)
+ nf_nat_ipv4_in(ops, skb, state, F0)
     ...>
 }
...
identifier state;
@@
 unsigned int nf_nat_ipv4_fn(const struct nf_hook_ops * ops, struct sk_buff * skb, const struct nf_hook_state * state, unsigned int (*)(const struct nf_hook_ops *, struct sk_buff *, const struct nf_hook_state *, struct nf_conn *) do_chain)
 {
     <...
...
@@
 ...
 {
     <...
- nf_nat_ipv4_fn(ops, skb, state->in, state->out, F0)
+ nf_nat_ipv4_fn(ops, skb, state, F0)
     ...>
 }
